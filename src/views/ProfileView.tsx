  ...
  return (
    <div className="animate-fade" style={{ maxWidth: '600px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '32px' }}>
      ...
      <div className="glass card" style={{ padding: '40px', borderRadius: '16px', display: 'flex', flexDirection: 'column', gap: '24px', background: 'var(--panel-bg)', border: '1px solid var(--glass-border)' }}>
        ...
        {!isNative && (
          <div style={{ display: 'flex', gap: '12px', padding: '16px', background: 'rgba(255, 177, 66, 0.1)', borderLeft: '4px solid #ffb142', borderRadius: '8px' }}>
            <Info size={20} style={{ color: '#ffb142', flexShrink: 0 }} />
            <span style={{ fontSize: '0.85rem', color: 'var(--text-main)', lineHeight: 1.5 }}>
              <strong>ブラウザ環境で起動中:</strong> 実際のバイブレーションやプッシュ通知は、Androidの実機アプリ版でのみ動作します。現在のブラウザ環境では機能しません。
            </span>
          </div>
        )}
