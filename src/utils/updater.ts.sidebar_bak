...
// 現在のアプリバージョン
export const CURRENT_VERSION = '2.2.20'; // 2.2.20 (表示数・共有・アプリ移動機能実装・共有バグ＆プレビューOGP画像・動画R2・プレビュー再生・画像動画閲覧時カウント・カスタムプレイヤー・OSメディアコントロール安全化・Capawesome native media session統合・シーク位置秒数同期対応版)
